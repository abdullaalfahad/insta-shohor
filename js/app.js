...
const switchTab = (id) => {
  if (id === "posts") {
    ...
    document.getElementById("extra-question").style.display = "block";
  } else if (id === "liked") {
    document.getElementById("liked").style.display = "block";
    document.getElementById("posts").style.display = "none";
    document.getElementById("reported").style.display = "none";
    document.getElementById("extra-question").style.display = "none";
...
const displayLikedPosts = () => {
  ...
  const likedContainer = document.getElementById("liked-posts");
...
const displayReportedPosts = () => {
  ...
  const reportedContainer = document.getElementById("reported-posts");
